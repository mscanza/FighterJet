...
function FighterJet(left, top, width, height, rateOfFire, maxHealth, enemy) {
  ...
  this.score = 0;
  this.accelRate = enemy ? 0.1 : 0.2;
  this.decelerationRate = enemy ? 0 : 0.2;
...
function directionToFly(fighterJet, enemy) {
  ...
  if (fighterJet.flyRight) {
    fighterJet.rightAccel += fighterJet.accelRate;
  } else if (fighterJet.rightAccel > 0) {
      fighterJet.rightAccel -= fighterJet.decelerationRate;
  }
  ...
  if (fighterJet.flyUp) {
    fighterJet.topAccel -= fighterJet.accelRate;
  } else if (fighterJet.topAccel < 0) {
    fighterJet.topAccel += fighterJet.decelerationRate;
  }
